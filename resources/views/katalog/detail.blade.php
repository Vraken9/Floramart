                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
                    ...
                    <div class="p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 mt-auto">
                            <a href="{{ route('product.whatsapp', $product->id) }}" target="_blank" class="flex-1 inline-flex justify-center items-center px-8 py-4 bg-[#7c4959] border border-transparent rounded-xl font-bold text-white uppercase tracking-wider hover:bg-[#5d3642] shadow-md transition-all">
                                Pesan via WhatsApp
                            </a>
